...
export default function Orders() {
    ...
    return (
        <div className="flex flex-col items-center p-4 text-white gap-5 w-full">
            <h1 className="text-xl mt-4 self-baseline font-anton font-semibold md:text-2xl">Meus pedidos</h1>
            {orders && orders.length > 0 ? <div className="flex flex-col md:grid md:grid-cols-2 w-full gap-6 ">
                ...
                border-gray-600  ">
                        ...
                        <Link to={`/orderInfo/${orderId}`} className="ml-auto px-2 py-1 border mt-auto border-gray-500 font-serif font-thin rounded-md md:py-2 md:px-4">Detalhes</Link>

                    </div>

                })}
            </div> : <div className="flex flex-col items-center justify-center mt-10 mb-16 ">
