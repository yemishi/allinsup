        ...
        {desc.map((description, index) => {
          ...
          return (
            <tr
              ...
              className="grid grid-cols-2 first:rounded-tl-lg"
            >
              <th
              ...
              <td
                className={`font-thin bg-secondary-200 bg-opacity-40 py-4 lg:py-6 pl-2 lg:pl-4 pr-4 border-b  border-gray-500 ${
