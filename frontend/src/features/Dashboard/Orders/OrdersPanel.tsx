...
export default function OrdersPanel() {
    ...
    const inputClass = `block py-2.5 ps-2 lg:text-lg pe-0 w-full text-sm md:text-base text-white bg-transparent border-primary-200 border-b border-gray-300 appearance-none focus:outline-none
    focus:ring-0 focus:border-secondary-600 peer`

    const labelClass = `absolute text-sm md:text-base lg:text-lg text-white text-opacity-50 duration-300 transform -translate-y-7 translate-x-1 scale-75 top-3 pointer-events-none origin-[0] 
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="relative w-4/5 lg:w-3/6 self-center mt-5">
