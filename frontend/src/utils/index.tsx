...
import { stickyVariant, productDetails, findInArray, reloadPage } from "./helpers";
import { slideOptions, divList } from "./templates"
export {
    totalAmount, divList, slideOptions, productDetails, reloadPage, parseToNumber, urlReplace, stickyVariant, totalPrice, findInArray,
