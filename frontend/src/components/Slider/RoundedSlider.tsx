    ...
    return (
        <Slider settings={settings}>
            {children?.map((e) => {
                ...
                m:font-semibold md:text-lg  ${current ? "text-secondary-200" : "text-white"}`}>

                    <div className={`h-[110px] w-[110px] lg:h-[125px] lg:w-[125px] overflow-hidden duration-200 bg-primary rounded-full border-2 
